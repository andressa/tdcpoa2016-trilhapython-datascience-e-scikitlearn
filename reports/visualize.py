...
class visualization(object):
    ...
    def plot_confusion_matrix(cm, title='Matriz de Confusão', cmap=plt.cm.Blues):
        ...
        plt.xlabel('Conjunto de Teste')
        plt.grid(False)

        for i, j in ((x,y) for x in range(len(cm)) for y in range(len(cm[0]))):
    ...
    def plot_classification_report(self, classification_report, title='Desempenho do Classificador ', cmap='RdBu'):
        '''
